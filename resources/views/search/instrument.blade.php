...
<div class="page-pick-the-instrument screen">
        ...
        <div class="frame-21-C61RwL">
            ...
            <a href="{{ route('search-by-instrument') }}">
                <div class="instrument-G2B5sx valign-text-middle">Instrument</div>
            </a>
            <a href="{{ route('search-by-energy-level') }}">
                <div class="energy-level-G2B5sx valign-text-middle ourstorybeginsfree-regular-normal-eerie-black-30px">
                Energy level
                </div>
            </a>
        ...
        <a href='/'>
            ...
            <img class="barking-owl-C61RwL" src="img/barking-owl-6@2x.svg" />
        </a>
        <a href='/profile'>
        ...
        <img class="rectangle-77-C61RwL" src="img/rectangle-77-2@2x.svg" />
        <img class="ellipse-1-C61RwL" src="img/ellipse-1@2x.svg" />
        <div class="rectangle-76-mzXdH9 border-1px-black"></div>
        <img class="rectangle-77-VMr6Om" src="img/rectangle-77-3@2x.svg" />
        ...
        <div class="heart-1-C61RwL"><img class="vector-xE3uHn" src="img/vector-54@2x.svg" /></div>
        ...
        <div class="heart-1-VMr6Om"><img class="vector-Olt1FA" src="img/vector-54@2x.svg" /></div>
        ...
        <div class="heart-1-mzXdH9"><img class="vector-nkqx4q" src="img/vector-54@2x.svg" /></div>
        ...
        <div class="heart-1-QxM5SU"><img class="vector-Pqpd5x" src="img/vector-54@2x.svg" /></div>
        ...
        <div class="heart-1-2P4qUJ"><img class="vector-MOcxBe" src="img/vector-54@2x.svg" /></div>
        ...
        <div class="heart-1-qr8e7q"><img class="vector-DyTV0E" src="img/vector-54@2x.svg" /></div>
        ...
        <div class="heart-1-J1YQmd"><img class="vector-LG06OP" src="img/vector-54@2x.svg" /></div>
        ...
        <div class="heart-1-a5WPlX"><img class="vector-wiL0hc" src="img/vector-54@2x.svg" /></div>
        ...
        <div class="heart-1-HlKRTo"><img class="vector-RcwfUe" src="img/vector-54@2x.svg" /></div>
        ...
        <div class="heart-1-VkPPtx"><img class="vector-fLGRxx" src="img/vector-54@2x.svg" /></div>
