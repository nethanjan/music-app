...
<div class="page-pick-the-mood screen">
    ...
    <a href='/'>
        ...
        <img class="barking-owl-C61RwL" src="img/barking-owl-9@2x.svg" />
    </a>
    ...
    <div class="frame-21-C61RwL">
        ...
        <img class="rectangle-77-C61RwL" src="img/rectangle-77-6@2x.svg" />
        <img class="ellipse-1-C61RwL" src="img/ellipse-1@2x.svg" />
        <div class="rectangle-76-mzXdH9 border-1px-black"></div>
        <img class="rectangle-77-VMr6Om" src="img/rectangle-77-7@2x.svg" />
