...
<div class="tabs">
    ...
    <form class="module-spacer form" method="POST" action="/profile">
        ...
        <div class="container form-container">
            <div class="form-group">
                ...
                <div class="form-control">
                    <input type="text" id="fname" name="fname" placeholder="" value="{{ old('fname') ? old('fname') : $user->fname }}"/>
                    @error('fname')
            ...
            <div class="form-group">
                ...
                <div class="form-control">
                    <input id="lname" name="lname" placeholder="" type="text" value="{{ old('lname') ? old('lname') : $user->lname }}"/>
                    @error('lname')
                        <span class="error required">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="form-group">
                ...
                <div class="form-control">
                    <input name="email" id="email" placeholder="" type="text"  value="{{ old('email') ? old('email') : $user->email }}" />
                    @error('email')
                        <span class="error required">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <button class="btn btn-submit" type="submit">Change Details</button>
            @if(session()->has('success'))
                <div class="form-notice variation-one">
                {{ session()->get('success') }}
                </div>
            @endif
